...
console.log("mongodb://"+process.env.MONGODB_URL+":"+process.env.MONGODB_PORT+"/"+process.env.MONGODB_DB_NAME+'"');
...
// /* NOW PUT ALL THE DATA IN DB */
        var tweetdatas_db = mongoose.model(process.env.MONGODB_COL_NAME_public_stream, tdata);
  ...
  console.log('Public Log Updated!');
        ...
        if (geo_coordinates != "null") {
                ...
                try {
                    ...
                    var options = {
                        host: MS_VENUE_SEARCH_HOST,
                        port: MS_VENUE_SEARCH_PORT,
